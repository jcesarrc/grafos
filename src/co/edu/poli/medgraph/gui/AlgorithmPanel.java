...
public class AlgorithmPanel extends JPanel implements AlgorithmProgressListener<DijkstraStepChanges>, GraphChangeListener {
    ...
    public AlgorithmPanel() {
        ...
        /*
         * Slider para velocidad de simulacion
         */
        ...
        /*
         * Botonoes de control del algoritmo
         */
    ...
    public Task<Void, Void> playPause() {
        ...
        // inicia de nuevo cuando finalice
